            ...
            <div className="container flex h-16 items-center justify-between px-6 max-w-screen-2xl">
                ...
                <div className="flex items-center gap-4">
                    <SignedOut>
                        ...
                        <SignInButton mode="modal">
                            <Button size="sm" variant="outline" className="text-xs font-bold uppercase tracking-widest border-black text-black hover:bg-black hover:text-white rounded-none px-6 h-9">
                                Contact Sales
                            </Button>
                        </SignInButton>
                    </SignedOut>
